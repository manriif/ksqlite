...
public expect class CipherParams public constructor() :
    ...
    override var m_value: Int
    override var m_default: Int
    override var m_minValue: Int
    override var m_maxValue: Int

    public companion object : StructLayout<CipherParams> {
        override fun cleanup(instance: CipherParams)
    }
}