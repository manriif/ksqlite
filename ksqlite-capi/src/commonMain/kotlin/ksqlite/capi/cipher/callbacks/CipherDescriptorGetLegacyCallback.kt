...
/**
 * This is a boolean function returning the legacy mode of a cipher scheme (see legacy mode for
 * further details).
 *
 * [CipherDescriptor](https://utelle.github.io/SQLite3MultipleCiphers/docs/ciphers/cipher_dynamic/#cipher-descriptor)
 */
public fun interface CipherDescriptorGetLegacyCallback<Cipher : Any> {
