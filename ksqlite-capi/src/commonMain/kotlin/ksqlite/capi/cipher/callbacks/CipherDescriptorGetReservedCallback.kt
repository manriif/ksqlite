...
/**
 * This function returns the number of reserved bytes per database page. The reserved bytes are used
 * to store a HMAC (or other data) used by the cipher scheme to verify database page consistency.
 *
 * [CipherDescriptor](https://utelle.github.io/SQLite3MultipleCiphers/docs/ciphers/cipher_dynamic/#cipher-descriptor)
 */
public fun interface CipherDescriptorGetReservedCallback<Cipher : Any> {
