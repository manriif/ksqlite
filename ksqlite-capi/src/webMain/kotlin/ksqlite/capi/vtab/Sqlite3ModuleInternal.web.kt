...
private val vTabCursorPVtabMemberCursor = sqlite3.capi.sqlite3_vtab_cursor.structInfo
    .member(sqlite3_vtab_cursor::pVtab)
    .offset
...
internal val VTabCreateHandler = vTabHook(I64, I32, I64, I64, I64, I64) { db: WasmPointer,
...
internal val VTabConnectHandler = vTabHook(I64, I32, I64, I64, I64, I64) { db: WasmPointer,
                                                                           refPointer: WasmPointer,
                                                                           argc: Int,
                                                                           argv: WasmPointer,
                                                                           ppVtab: WasmPointer,
...
internal val VTabBestIndexHandler = vTabHook(I64, I64) { vTab: WasmPointer, info: WasmPointer ->
    vTabBestIndex(
        vTab = vTab.toLong(),
...
internal val VTabDisconnectHandler = vTabHook(I64) { vTab: WasmPointer ->
    vTabDisconnect(vTab.toLong())
}

internal val VTabDestroyHandler = vTabHook(I64) { vTab: WasmPointer ->
    vTabDestroy(vTab.toLong())
}

internal val VTabOpenHandler = vTabHook(I64, I64) { vTab: WasmPointer, outCursor: WasmPointer ->
    vTabOpen(
        vTab = vTab.toLong(),
...
internal val VTabCloseHandler = vTabHook(I64) { cursor: WasmPointer ->
    vTabClose(
...
internal val VTabFilterHandler = vTabHook(I64, I32, I64, I32, I64) { cursor: WasmPointer,
                                                                     idxNum: Int,
                                                                     idxStr: WasmPointer,
                                                                     argc: Int,
                                                                     argv: WasmPointer ->
...
internal val VTabNextHandler = vTabHook(I64) { cursor: WasmPointer ->
    vTabNext(
        vTab = vTabPointerAddressFromCursor(cursor),
        cursor = cursor.toLong()
    )
...
internal val VTabEofHandler = vTabHook(I64) { cursor: WasmPointer ->
    vTabEof(
        vTab = vTabPointerAddressFromCursor(cursor),
        cursor = cursor.toLong()
    )
...
internal val VTabColumnHandler = vTabHook(I64, I64, I32) { cursor: WasmPointer,
                                                           context: WasmPointer,
                                                           columnIndex: Int ->
    vTabColumn(
        vTab = vTabPointerAddressFromCursor(cursor),
...
internal val VTabRowidHandler = vTabHook(I64, I64) { cursor: WasmPointer, outRowId: WasmPointer ->
    vTabRowid(
        vTab = vTabPointerAddressFromCursor(cursor),
        cursor = cursor.toLong(),
...
internal val VTabUpdateHandler = vTabHook(I64, I32, I64, I64) { vTab: WasmPointer,
                                                                argc: Int,
                                                                argv: WasmPointer,
...
internal val VTabBeginHandler = vTabHook(I64) { vTab: WasmPointer ->
    vTabBegin(vTab.toLong())
}

internal val VTabSyncHandler = vTabHook(I64) { vTab: WasmPointer ->
    vTabSync(vTab.toLong())
}

internal val VTabCommitHandler = vTabHook(I64) { vTab: WasmPointer ->
    vTabCommit(vTab.toLong())
}

internal val VTabRollbackHandler = vTabHook(I64) { vTab: WasmPointer ->
    vTabRollback(vTab.toLong())
}

internal val VTabFindFunctionHandler = vTabHook(I64, I32, I64, I64, I64) { vTab: WasmPointer,
                                                                           argc: Int,
                                                                           name: WasmPointer,
                                                                           outFn: WasmPointer,
                                                                           outData: WasmPointer ->
...
internal val VTabRenameHandler = vTabHook(I64, I64) { vTab: WasmPointer, newName: WasmPointer ->
    vTabRename(
        vTab = vTab.toLong(),
...
internal val VTabSavepointHandler = vTabHook(I64, I32) { vTab: WasmPointer, savepoint: Int ->
    vTabSavepoint(
        vTab = vTab.toLong(),
        savepoint = savepoint
    )
...
internal val VTabReleaseHandler = vTabHook(I64, I32) { vTab: WasmPointer, savepoint: Int ->
    vTabRelease(
        vTab = vTab.toLong(),
        savepoint = savepoint
    )
...
internal val VTabRollbackToHandler = vTabHook(I64, I32) { vTab: WasmPointer, savepoint: Int ->
    vTabRollbackTo(
        vTab = vTab.toLong(),
        savepoint = savepoint
    )
...
internal val VTabIntegrityHandler = vTabHook(I64, I64, I64, I32, I64) { vtab: WasmPointer,
                                                                        schema: WasmPointer,
