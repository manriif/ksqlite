...
public actual class CipherParams private constructor(
    ...
    actual override var m_name: String
        ...
        set(value) {
            exports.sqlite3_free(params.m_name)
            params.m_name = sqlite3_mprintf(value)
        }
