...
public interface WriteAheadLogCheckpointResult {
    ...
    /**
     * Total number of frames in the log file, or -1 if the checkpoint could not run because of an
     ...
     * checkpointed before the function was called, or -1 if the checkpoint could not run due to an
     * error or because the database is not in WAL mode.
     */
