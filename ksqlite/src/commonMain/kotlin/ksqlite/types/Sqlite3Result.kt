...
public sealed class Sqlite3Result(public val code: Int) {
     ...
     */
    public sealed class DONE(code: Int) : Sqlite3Result(code) {
     ...
     * available.
     */
    public sealed class ROW(code: Int) : Sqlite3Result(code) {
        /**
...
/**
 * Returns all [Sqlite3Result]s.
 */
internal fun sqlite3Results(): Set<Sqlite3Result> = setOf(
    Sqlite3Result.ABORT,
