...
/**
 * Converts [resultCode] to [Boolean].
 */
internal fun convertBooleanResult(resultCode: Int): Boolean = when (resultCode) {
    0 -> false
    1 -> true
    else -> error("Unexpected integer result $resultCode for boolean conversion")
}
