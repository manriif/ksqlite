 ...
 * The [sqlite3_backup] object is created by a call to [ksqlite.sqlite3_backup_init] and is destroyed by a
 * call to [ksqlite.sqlite3_backup_finish].
 *
 ...
 * performed.
 * Objects of this type are created by [ksqlite.sqlite3_blob_open] and destroyed by [ksqlite.sqlite3_blob_close].
 * The [ksqlite.sqlite3_blob_read] and [ksqlite.sqlite3_blob_write] interfaces can be used to read or write small
