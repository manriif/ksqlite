...
import ksqlite.foreign.js.arrayJoinToString
 ...
 */
public external interface WasmFunctions {
     ...
     */
    public fun functionTable(): JsAny
     ...
     */
    public fun xCallWrapped(
        functionName: JsString,
        resultType: JsString,
        argsTypes: ReadonlyArray<JsString>,
        vararg args: JsAny
    ): JsAny
     ...
     */
    public fun xGet(functionName: JsString): WasmFunction
     ...
     */
    public fun scopedInstallFunction(
        funcSignature: JsString,
        function: JsFunction
    ): WasmPointer
     ...
     */
    public fun uninstallFunction(pointer: WasmPointer): WasmFunction
}
 ...
 */
public value class FunctionSignature(internal val signature: String) {
    ...
    public sealed interface Result {
        ...
        public operator fun invoke(vararg parameterTypes: Parameter): FunctionSignature {
            val parameters = arrayJoinToString(parameterTypes, "", Parameter::value)
            return FunctionSignature("$value$parameters")
        }
    }

    public data object Pointer : Result, Parameter {
        override val value: Char
            get() = 'p'
    }

    public data object Int32 : Result, Parameter {
        override val value: Char
            get() = 'i'
    }

    public data object Int64 : Result, Parameter {
        override val value: Char
            get() = 'j'
    }

    public data object Float32 : Result, Parameter {
        override val value: Char
            get() = 'f'
    }

    public data object Float64 : Result, Parameter {
        override val value: Char
            get() = 'd'
    }

    public data object Void : Result {
        override val value: Char
            get() = 'v'
    }
}
