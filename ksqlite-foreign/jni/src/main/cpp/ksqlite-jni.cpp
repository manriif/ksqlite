...
#define RequireKsqliteClass(className) RequireClass("ksqlite/foreign/" className)
...
#define RequireKsqliteClassMethod(klass, name, signature, className) \
    RequireClassMethod(klass, name, signature, "ksqlite/foreign/" className)
...
#define RequireKsqliteClassField(klass, name, signature, className) \
    RequireClassField(klass, name, signature, "ksqlite/foreign/" className)
...
static void initializeKsqliteJniCache(JNIEnv* env) {
    ...
    KKVC.create = RequireKsqliteMethod(
        ...
        "(JLjava/lang/Object;"
        "[Ljava/lang/String;"
        "Lksqlite/foreign/OutputPointer$OfPointer;"
        "Lksqlite/foreign/OutputPointer$OfString;)I",
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_nativeBufferWrite(
    JNIEnv* env,
    jclass clazz,
    jlong buffer,
    jbyteArray source,
...
static char* jstringToUtf8(
    ...
    if (length == 0) {
        ...
        const auto utf8 = static_cast<char*>(sqlite3_malloc(1));
...
Java_ksqlite_foreign_KsqliteJni_nativeReadString(
    JNIEnv* env,
    jclass clazz,
    jlong pointer
) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_nativeFreeAndMalloc(
    JNIEnv* env,
    jclass clazz,
    jlong pointer,
    jstring message
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_nativeStructFree(
    JNIEnv* env,
    jclass clazz,
    jobject buffer
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_ksqlite_1auto_1extension(
    JNIEnv* env,
    jclass clazz,
    jobject callback
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_ksqlite_1cancel_1auto_1extension(
    JNIEnv* env,
    jclass clazz,
    jobject callback
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_ksqlite_1prepare_1v2(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jbyteArray sql,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_ksqlite_1prepare_1v3(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jbyteArray sql,
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1aggregate_1context(
    JNIEnv* env,
    jclass clazz,
    jlong context,
    jboolean create
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1autovacuum_1pages(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jobject callback,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1backup_1finish(
    JNIEnv* env,
    jclass clazz,
    jlong backup
) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1backup_1init(
    JNIEnv* env,
    jclass clazz,
    jlong destDb,
    jstring destDbName,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1backup_1pagecount(
    JNIEnv* env,
    jclass clazz,
    jlong backup
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1backup_1remaining(
    JNIEnv* env,
    jclass clazz,
    jlong backup
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1backup_1step(
    JNIEnv* env,
    jclass clazz,
    jlong backup,
    jint nPage
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1bind_1blob(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1bind_1blob64(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1bind_1double(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1bind_1int(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1bind_1int64(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1bind_1null(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1bind_1parameter_1count(
    JNIEnv* env,
    jclass clazz,
    jlong stmt
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1bind_1parameter_1index(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jstring name
...
extern "C"
JNIEXPORT jstring JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1bind_1parameter_1name(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1bind_1pointer(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1bind_1text(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1bind_1text64(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1bind_1value(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1bind_1zeroblob(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1bind_1zeroblob64(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1blob_1bytes(
    JNIEnv* env,
    jclass clazz,
    jlong blob
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1blob_1close(
    JNIEnv* env,
    jclass clazz,
    jlong blob
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1blob_1open(
    JNIEnv* env,
    jclass clazz,
    jlong db,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1blob_1read(
    JNIEnv* env,
    jclass clazz,
    jlong blob,
    jbyteArray buffer,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1blob_1reopen(
    JNIEnv* env,
    jclass clazz,
    jlong blob,
    jlong rowIndex
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1blob_1write(
    JNIEnv* env,
    jclass clazz,
    jlong blob,
    jbyteArray buffer,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1busy_1handler(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jobject callback
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1busy_1timeout(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jint millis
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1changes(
    JNIEnv* env,
    jclass clazz,
    jlong db
) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1changes64(
    JNIEnv* env,
    jclass clazz,
    jlong db
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1clear_1bindings(
    JNIEnv* env,
    jclass clazz,
    jlong stmt
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1close(
    JNIEnv* env,
    jclass clazz,
    jlong db
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1close_1v2(
    JNIEnv* env,
    jclass clazz,
    jlong db
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1collation_1needed(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jobject callback
...
Java_ksqlite_foreign_KsqliteJni_sqlite3_1column_1blob(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1column_1buffer(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1column_1bytes(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1column_1count(
    JNIEnv* env,
    jclass clazz,
    jlong stmt
) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1column_1database_1name(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index
...
extern "C"
JNIEXPORT jstring JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1column_1decltype(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index
...
Java_ksqlite_foreign_KsqliteJni_sqlite3_1column_1double(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1column_1int(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1column_1int64(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index
...
extern "C"
JNIEXPORT jstring JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1column_1name(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index
...
extern "C"
JNIEXPORT jstring JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1column_1origin_1name(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index
...
extern "C"
JNIEXPORT jstring JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1column_1table_1name(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index
...
extern "C"
JNIEXPORT jstring JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1column_1text(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1column_1type(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1column_1value(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint index
...
extern "C"
JNIEXPORT jobject JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1commit_1hook(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jobject callback
...
extern "C"
JNIEXPORT jstring JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1compileoption_1get(
    JNIEnv* env,
    jclass clazz,
    jint index
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1compileoption_1used(
    JNIEnv* env,
    jclass clazz,
    jstring name
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1complete(
    JNIEnv* env,
    jclass clazz,
    jstring sql
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1config(
    JNIEnv* env,
    jclass clazz,
    jint id,
    jobjectArray args
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1context_1db_1handle(
    JNIEnv* env,
    jclass clazz,
    jlong context
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1create_1collation_1v2(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring name,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1create_1function_1v2(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring name,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1create_1module_1v2(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring name,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1create_1window_1function(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring name,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1data_1count(
    JNIEnv* env,
    jclass clazz,
    jlong stmt
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1db_1cacheflush(
    JNIEnv* env,
    jclass clazz,
    jlong db
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1db_1config(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jint option,
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1db_1handle(
    JNIEnv* env,
    jclass clazz,
    jlong stmt
) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1db_1name(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jint index
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1db_1readonly(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring name
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1db_1release_1memory(
    JNIEnv* env,
    jclass clazz,
    jlong db
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1db_1status(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jint option,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1db_1status64(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jint option,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1declare_1vtab(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring sql
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1deserialize(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring schema,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1drop_1modules(
    JNIEnv* env,
    jclass clazz,
    jlong db,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1errcode(
    JNIEnv* env,
    jclass clazz,
    jlong db
) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1errmsg(
    JNIEnv* env,
    jclass clazz,
    jlong db
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1error_1offset(
    JNIEnv* env,
    jclass clazz,
    jlong db
) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1errstr(
    JNIEnv* env,
    jclass clazz,
    jint resultCode
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1exec(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring sql,
...
extern "C"
JNIEXPORT jstring JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1expanded_1sql(
    JNIEnv* env,
    jclass clazz,
    jlong stmt
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1extended_1errcode(
    JNIEnv* env,
    jclass clazz,
    jlong db
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1extended_1result_1codes(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jint enabled
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1file_1control(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring name,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1finalize(
    JNIEnv* env,
    jclass clazz,
    jlong stmt
) {
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1free(
    JNIEnv* env,
    jclass clazz,
    jlong buffer
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1get_1autocommit(
    JNIEnv* env,
    jclass clazz,
    jlong db
) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1hard_1heap_1limit64(
    JNIEnv* env,
    jclass clazz,
    jlong limit
) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1get_1auxdata(
    JNIEnv* env,
    jclass clazz,
    jlong context,
    jint index
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1initialize(
    JNIEnv* env,
    jclass clazz
) {
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1interrupt(
    JNIEnv* env,
    jclass clazz,
    jlong db
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1is_1interrupted(
    JNIEnv* env,
    jclass clazz,
    jlong db
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1key(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jbyteArray key,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1key_1v2(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring dbName,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1keyword_1check(
    JNIEnv* env,
    jclass clazz,
    jstring word
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1keyword_1count(
    JNIEnv* env,
    jclass clazz
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1keyword_1name(
    JNIEnv* env,
    jclass clazz,
    jint index,
    jobject name
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1last_1insert_1rowid(
    JNIEnv* env,
    jclass clazz,
    jlong db
) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1libversion(
    JNIEnv* env,
    jclass clazz
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1libversion_1number(
    JNIEnv* env,
    jclass clazz
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1limit(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jint id,
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1log(
    JNIEnv* env,
    jclass clazz,
    jint errorCode,
    jstring message
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1malloc(
    JNIEnv* env,
    jclass clazz,
    jint size
) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1malloc64(
    JNIEnv* env,
    jclass clazz,
    jlong size
) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1memory_1used(
    JNIEnv* env,
    jclass clazz
) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1memory_1highwater(
    JNIEnv* env,
    jclass clazz,
    jint resetFlag
) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1msize(
    JNIEnv* env,
    jclass clazz,
    jlong buffer
) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1next_1stmt(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jlong stmt
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1open(
    JNIEnv* env,
    jclass clazz,
    jstring fileName,
    jobject outDb
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1open_1v2(
    JNIEnv* env,
    jclass clazz,
    jstring fileName,
    jobject outDb,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1overload_1function(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring name,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1prepare_1v2(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring sql,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1prepare_1v3(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring sql,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1preupdate_1blobwrite(
    JNIEnv* env,
    jclass clazz,
    jlong db
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1preupdate_1count(
    JNIEnv* env,
    jclass clazz,
    jlong db
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1preupdate_1depth(
    JNIEnv* env,
    jclass clazz,
    jlong db
) {
...
extern "C"
JNIEXPORT jobject JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1preupdate_1hook(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jobject callback
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1preupdate_1new(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jint index,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1preupdate_1old(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jint index,
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1progress_1handler(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jint nOps,
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1randomness(
    JNIEnv* env,
    jclass clazz,
    jint size,
    jlong buffer
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1realloc(
    JNIEnv* env,
    jclass clazz,
    jlong buffer,
    jint size
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1realloc64(
    JNIEnv* env,
    jclass clazz,
    jlong buffer,
    jlong size
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1rekey(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jbyteArray key,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1rekey_1v2(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring dbName,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1release_1memory(
    JNIEnv* env,
    jclass clazz,
    jint size
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1reset(
    JNIEnv* env,
    jclass clazz,
    jlong stmt
) {
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1reset_1auto_1extension(
    JNIEnv* env,
    jclass clazz
) {
    MutexEnter(KHS);
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1result_1blob(
    JNIEnv* env,
    jclass clazz,
    jlong context,
    jbyteArray bytes,
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1result_1blob64(
    JNIEnv* env,
    jclass clazz,
    jlong context,
    jlong buffer,
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1result_1double(
    JNIEnv* env,
    jclass clazz,
    jlong context,
    jdouble value
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1result_1error(
    JNIEnv* env,
    jclass clazz,
    jlong context,
    jstring message
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1result_1error_1code(
    JNIEnv* env,
    jclass clazz,
    jlong context,
    jint errorCode
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1result_1error_1nomem(
    JNIEnv* env,
    jclass clazz,
    jlong context
) {
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1result_1error_1toobig(
    JNIEnv* env,
    jclass clazz,
    jlong context
) {
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1result_1int(
    JNIEnv* env,
    jclass clazz,
    jlong context,
    jint value
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1result_1int64(
    JNIEnv* env,
    jclass clazz,
    jlong context,
    jlong value
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1result_1null(
    JNIEnv* env,
    jclass clazz,
    jlong context
) {
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1result_1pointer(
    JNIEnv* env,
    jclass clazz,
    jlong context,
    jobject data,
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1result_1subtype(
    JNIEnv* env,
    jclass clazz,
    jlong context,
    jint subtype
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1result_1text(
    JNIEnv* env,
    jclass clazz,
    jlong context,
    jstring value
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1result_1text64(
    JNIEnv* env,
    jclass clazz,
    jlong context,
    jlong buffer,
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1result_1value(
    JNIEnv* env,
    jclass clazz,
    jlong context,
    jlong value
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1result_1zeroblob(
    JNIEnv* env,
    jclass clazz,
    jlong context,
    jint size
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1result_1zeroblob64(
    JNIEnv* env,
    jclass clazz,
    jlong context,
    jlong size
...
extern "C"
JNIEXPORT jobject JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1rollback_1hook(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jobject callback
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1serialize(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring schema,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1set_1authorizer(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jobject callback
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1set_1auxdata(
    JNIEnv* env,
    jclass clazz,
    jlong context,
    jint index,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1set_1errmsg(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jint errorCode,
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1set_1last_1insert_1rowid(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jlong rowId
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1shutdown(
    JNIEnv* env,
    jclass clazz
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1snapshot_1cmp(
    JNIEnv* env,
    jclass clazz,
    jlong snapshot1,
    jlong snapshot2
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1snapshot_1free(
    JNIEnv* env,
    jclass clazz,
    jlong snapshot
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1snapshot_1get(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring name,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1snapshot_1open(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring name,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1snapshot_1recover(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring name
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1soft_1heap_1limit64(
    JNIEnv* env,
    jclass clazz,
    jlong limit
) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1sourceid(
    JNIEnv* env,
    jclass clazz
) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1sql(
    JNIEnv* env,
    jclass clazz,
    jlong stmt
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1status(
    JNIEnv* env,
    jclass clazz,
    jint option,
    jobject outCurrent,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1status64(
    JNIEnv* env,
    jclass clazz,
    jint option,
    jobject outCurrent,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1step(
    JNIEnv* env,
    jclass clazz,
    jlong stmt
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1stmt_1busy(
    JNIEnv* env,
    jclass clazz,
    jlong stmt
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1stmt_1explain(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint mode
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1stmt_1isexplain(
    JNIEnv* env,
    jclass clazz,
    jlong stmt
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1stmt_1readonly(
    JNIEnv* env,
    jclass clazz,
    jlong stmt
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1stmt_1status(
    JNIEnv* env,
    jclass clazz,
    jlong stmt,
    jint counter,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1strglob(
    JNIEnv* env,
    jclass clazz,
    jstring pattern,
    jstring input
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1stricmp(
    JNIEnv* env,
    jclass clazz,
    jstring first,
    jstring second
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1strlike(
    JNIEnv* env,
    jclass clazz,
    jstring pattern,
    jstring input,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1strnicmp(
    JNIEnv* env,
    jclass clazz,
    jstring first,
    jstring second,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1system_1errno(
    JNIEnv* env,
    jclass clazz,
    jlong db
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1table_1column_1metadata(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring dbName,
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1total_1changes64(
    JNIEnv* env,
    jclass clazz,
    jlong db
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1trace_1v2(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jint mask,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1txn_1state(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring schema
...
extern "C"
JNIEXPORT jobject JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1update_1hook(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jobject callback
...
extern "C"
JNIEXPORT jobject JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1user_1data(
    JNIEnv* env,
    jclass clazz,
    jlong context
) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1value_1blob(
    JNIEnv* env,
    jclass clazz,
    jlong value
) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1value_1buffer(
    JNIEnv* env,
    jclass clazz,
    jlong value,
    jobject outSize
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1value_1bytes(
    JNIEnv* env,
    jclass clazz,
    jlong value
) {
...
extern "C"
JNIEXPORT jdouble JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1value_1double(
    JNIEnv* env,
    jclass clazz,
    jlong value
) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1value_1dup(
    JNIEnv* env,
    jclass clazz,
    jlong value
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1value_1encoding(
    JNIEnv* env,
    jclass clazz,
    jlong value
) {
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1value_1free(
    JNIEnv* env,
    jclass clazz,
    jlong value
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1value_1frombind(
    JNIEnv* env,
    jclass clazz,
    jlong value
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1value_1int(
    JNIEnv* env,
    jclass clazz,
    jlong value
) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1value_1int64(
    JNIEnv* env,
    jclass clazz,
    jlong value
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1value_1nochange(
    JNIEnv* env,
    jclass clazz,
    jlong value
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1value_1numeric_1type(
    JNIEnv* env,
    jclass clazz,
    jlong value
) {
...
extern "C"
JNIEXPORT jobject JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1value_1pointer(
    JNIEnv* env,
    jclass clazz,
    jlong value,
    jstring type
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1value_1subtype(
    JNIEnv* env,
    jclass clazz,
    jlong value
) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1value_1text(
    JNIEnv* env,
    jclass clazz,
    jlong value
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1value_1type(
    JNIEnv* env,
    jclass clazz,
    jlong value
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1vfs_1register(
    JNIEnv* env,
    jclass clazz,
    jlong vfs,
    jint makeDefault
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1vfs_1unregister(
    JNIEnv* env,
    jclass clazz,
    jlong vfs
) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1vtab_1collation(
    JNIEnv* env,
    jclass clazz,
    jlong info,
    jint index
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1vtab_1config(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jint option,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1vtab_1distinct(
    JNIEnv* env,
    jclass clazz,
    jlong info
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1vtab_1in(
    JNIEnv* env,
    jclass clazz,
    jlong info,
    jint index,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1vtab_1in_1first(
    JNIEnv* env,
    jclass clazz,
    jlong value,
    jobject outValue
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1vtab_1in_1next(
    JNIEnv* env,
    jclass clazz,
    jlong value,
    jobject outValue
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1vtab_1nochange(
    JNIEnv* env,
    jclass clazz,
    jlong context
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1vtab_1on_1conflict(
    JNIEnv* env,
    jclass clazz,
    jlong db
) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1vtab_1rhs_1value(
    JNIEnv* env,
    jclass clazz,
    jlong info,
    jint index,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1wal_1autocheckpoint(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jint nFrame
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1wal_1checkpoint(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring name
...
extern "C"
JNIEXPORT jint JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1wal_1checkpoint_1v2(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jstring name,
...
extern "C"
JNIEXPORT jobject JNICALL
Java_ksqlite_foreign_KsqliteJni_sqlite3_1wal_1hook(
    JNIEnv* env,
    jclass clazz,
    jlong db,
    jobject callback
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_nativeModuleInit(
    JNIEnv* env,
    jclass clazz,
    jlong module,
    jint callbackMask,
...
extern "C"
JNIEXPORT void JNICALL
Java_ksqlite_foreign_KsqliteJni_nativeModuleDeinit(
    JNIEnv* env,
    jclass clazz,
    jlong module
) {
